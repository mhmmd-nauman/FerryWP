...
function etm_languages_flags($specified = ''){
	...
	$flag_array['zw'] = array('code' => 'zw', 'org_name'=>'臺灣話','english_name'=>'Taiwanese', 'icon'=>'Taiwan-[size].png','default_locale'=>'zh_TW', 'default_pos'=> 0,'primary_order' =>0);
	...
	$flag_array['af'] = array('code' => 'af', 'org_name'=>'پښتو','english_name'=>'Pashto', 'icon'=>'Afghanistan_Pashto-[size].png','default_locale'=>'af_PS', 'default_pos'=> 0,'primary_order' =>0, 'rtl'=>true);
	$flag_array['ad'] = array('code' => 'ad', 'org_name'=>'دری','english_name'=>'Dari', 'icon'=>'Afghanistan_Dari-[size].png','default_locale'=>'af_DA', 'default_pos'=> 0,'primary_order' =>0, 'rtl'=>true);
	$flag_array['sr'] = array('code' => 'sr', 'org_name'=>'Suriname','english_name'=>'Suriname', 'icon'=>'Suriname-[size].png','default_locale'=>'sr_SR', 'default_pos'=> 0,'primary_order' =>0);
